...
#define MODEL_NAME_LEN 5  // e.g. "A530N"
#define BUILD_NAME_LEN 8  // e.g. "KSU9CUL1"
#define CODENAME_LEN   10 // e.g. "jackpotlte"
...
void vendor_load_properties()
{
    ...
    std::string model;  // A530N
    std::string device; // jackpotlte
    std::string name;    // jackpotltexxx
    ...
    if (device.size() == 0) {
        LOG(ERROR) << "Could not detect device, forcing jackpotlte";
        device = "jackpotlte";
    }
